package com.cabatuan.basicfiltering;
...
public class MainActivity extends Activity implements TextureView.SurfaceTextureListener, Camera.PreviewCallback {
    ...
    public native void filter(Bitmap pTarget, byte[] pSource, int pFilter);
    ...
    private Runnable DoImageProcessing = new Runnable() {
        ...
        public void run() {
            ...
            filter(imageA, videoSource, 1);
            filter(imageB, videoSource, 2);
            filter(imageC, videoSource, 3);
